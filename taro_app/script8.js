// Tarot Spread "Сад талантов" – 9 cards (3×3 grid)
...
async function startReading() {
    ...
    const question =
        `Расклад \"Сад талантов\" (9 карт)\n\n` +
        `Информация о кверенте:\nИмя: ${name}\nВозраст: ${age}\nДополнительная информация: ${additionalInfo || "—"}\n\n` +
        `Позиции карт:\n` +
        `1. Ядро таланта – Главный дар или призвание кверента.\n` +
        `2. Прошлый опыт – Как таланты проявлялись ранее?\n` +
        `3. Текущая возможность – Где можно применить таланты сейчас?\n` +
        `4. Внутренний барьер – Что сдерживает самореализацию?\n` +
        `5. Внешний барьер – Какие внешние факторы мешают?\n` +
        `6. Ключевое действие – Как раскрыть свой потенциал?\n` +
        `7. Поддержка окружения – Кто или что поможет в развитии?\n` +
        `8. Краткосрочный результат – Что даст использование талантов?\n` +
        `9. Долгосрочное видение – К чему приведёт развитие талантов?\n\n` +
    ...
    setTimeout(() => {
        ...
        const messages = [
            ...
            "Анализируем таланты и препятствия...",
            "Формируем прорицание...",
            "Раскрываем перспективы развития..."
        ];
        let i = 0;
