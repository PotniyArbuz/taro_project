// --------------------- NEW Spread: Путешествие мечты (9 карт, 3-3-3) ---------------------
...
async function startReading() {
    ...
    const question =
        `Расклад \"Путешествие мечты\" (9 карт)\n\n` +
        `Информация о кверенте:\nИмя: ${name}\nВозраст: ${age}\nДополнительная информация: ${additionalInfo || "—"}\n\n` +
        `Позиции карт:\n` +
        `1. Мечта о путешествии – Что вдохновляет на путь?\n` +
        `2. Прошлый опыт – Как прошлые путешествия влияют?\n` +
        `3. Текущая готовность – Насколько вы готовы к переменам?\n` +
        `4. Препятствие – Что мешает отправиться в путь?\n` +
        `5. Возможность – Какой шанс ждёт в путешествии?\n` +
        `6. Необходимое действие – Что сделать для старта?\n` +
        `7. Уроки пути – Что вы узнаете в процессе?\n` +
        `8. Пункт назначения – К чему приведёт путешествие?\n` +
        `9. Совет звёзд – Финальное напутствие для пути.\n\n` +
    ...
    // Геометрия раскладки (3-3-3, карта с дорогой)
    ...
    setTimeout(() => {
        ...
        const messages = [
            ...
            "Анализируем мечты и возможности...",
            "Формируем маршрут путешествия...",
            "Раскрываем горизонты пути..."
        ];
        let i = 0;
