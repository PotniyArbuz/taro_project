...
async function getYandexGPTResponse(question, selectedCards, userId) {
    try {
        const response = await fetch('https://ai-girls.ru/yandex-gpt', {
            ...
            body: JSON.stringify({ question, cards: selectedCards, user_id: userId, chat_id: chatId, source: "finance" })
        });
...
async function startReading() {
    ...
    "Расклад “Финансовый Потенциал” (7 карт)\n" +
    "1 карта - Текущее финансовое положение — что происходит сейчас в финансовой сфере, каковы основные тенденции и энергия.\n" +
    "2 карта - Главное препятствие — то, что мешает улучшить финансы: внешние обстоятельства, внутренние установки, поведение.\n" +
    "3 карта - Источник дохода — где лежит главный или потенциальный источник денег, на что стоит опереться.\n" +
    "4 карта - Скрытые ресурсы — способности, связи, таланты или ситуации, которые можно использовать, но они пока не осознаны.\n" +
    "5 карта - Финансовое будущее (ближайшее) — как будут развиваться события в ближайшем времени, если всё пойдёт по текущему сценарию.\n" +
    "6 карта - Финансовое будущее (долгосрочное) — общая перспектива развития финансов в более отдалённой перспективе.\n" +
    "7 карта - Совет Таро — что стоит делать, чтобы улучшить свою финансовую ситуацию, в каком направлении двигаться." +
