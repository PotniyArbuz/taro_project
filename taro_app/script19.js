// --------------------- NEW Spread: Принятие себя (9 карт, 3-3-3) ---------------------
...
async function startReading() {
    ...
    const question =
        `Расклад \"Принятие себя\" (9 карт)\n\n` +
        `Информация о кверенте:\nИмя: ${name}\nВозраст: ${age}\nДополнительная информация: ${additionalInfo || "—"}\n\n` +
        `Позиции карт:\n` +
        `1. Ядро личности – Кто вы в глубине души?\n` +
        `2. Прошлое восприятие – Как вы видели себя раньше?\n` +
        `3. Текущая самооценка – Как вы относитесь к себе сейчас?\n` +
        `4. Внутренний критик – Что мешает принять себя?\n` +
        `5. Скрытая сила – Какой аспект себя стоит ценить?\n` +
        `6. Действие для любви – Как полюбить себя?\n` +
        `7. Поддержка окружения – Кто помогает вам сиять?\n` +
        `8. Будущее восприятие – Как изменится отношение к себе?\n` +
        `9. Совет сердца – Финальное напутствие.\n\n` +
    ...
    // Геометрия раскладки (3-3-3, сердце)
    ...
    setTimeout(() => {
        ...
        const messages = [
            ...
            "Анализируем ваше внутреннее я...",
            "Формируем путь к самопринятию...",
            "Раскрываем свет вашей души..."
        ];
        let i = 0;
